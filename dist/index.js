...
function useTableState(tableId, smartColumns, defaultView, viewModes, initialPageSize, prefs, initialHiddenColumns) {
  ...
  const filterByGlobalSearch = useCallback((data) => {
  ...
  const hasIndicator = useCallback((colId) => {
  ...
  const cycleSort = useCallback((colId, opts) => {
  ...
  const openHeaderPopup = useCallback((colId, anchor) => {
...
function CellContextMenu({
  ...
  const actions = [
    ...
    },
    {
      ...
      icon: /* @__PURE__ */ jsx(ClipboardCopy, { className: "h-3.5 w-3.5" }),
      onClick: () => {
    ...
    ...onOpenRow ? [{
      ...
      icon: /* @__PURE__ */ jsx(ExternalLink, { className: "h-3.5 w-3.5" }),
      onClick: () => {
    ...
    ...onHideColumn && !target.column.fixed ? [{
      ...
      icon: /* @__PURE__ */ jsx(EyeOff, { className: "h-3.5 w-3.5" }),
      onClick: () => {
  ...
  return createPortal(
    /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxs("div", { className: "px-3 py-1.5 border-b border-slate-100 dark:border-slate-800", children: [
            /* @__PURE__ */ jsx("p", { className: "text-[10px] font-semibold uppercase tracking-wider text-slate-400", children: target.column.header }),
            /* @__PURE__ */ jsx("p", { className: "text-xs text-slate-700 dark:text-slate-300 truncate", title: cellText, children: cellText || /* @__PURE__ */ jsx("span", { className: "italic text-slate-400", children: t("context.empty") }) })
          ] }),
          actions.map((a, i) => /* @__PURE__ */ jsxs(
            "button",
            {
              onClick: a.onClick,
              className: clsx(
              ...
              children: [
                ...
                a.shortcut && /* @__PURE__ */ jsx("span", { className: "text-[10px] text-slate-400", children: a.shortcut })
              ]
            },
            i
          ))
...
function TableView({
  ...
  const [cogRect, setCogRect] = useState(null);
  ...
  const handleDragStart = useCallback((colId, e) => {
  ...
  const handleDrop = useCallback((targetColId, e) => {
    e.preventDefault();
  ...
  const onResizeStart = useCallback((header, e) => {
    e.stopPropagation();
    e.preventDefault();
  ...
  return /* @__PURE__ */ jsxs("div", { className: "relative", children: [
            ...
            "table",
            {
              ...
              children: [
                /* @__PURE__ */ jsxs("colgroup", { children: [
                  enableSelection && /* @__PURE__ */ jsx("col", { style: { width: CHECK_COL_W } }),
                  table.getVisibleLeafColumns().map((col) => /* @__PURE__ */ jsx("col", { style: { width: col.getSize() } }, col.id)),
                  /* @__PURE__ */ jsx("col", { style: { width: ACTIONS_COL_W } })
                ] }),
                /* @__PURE__ */ jsx("thead", { className: "sticky top-0 z-20 shadow-[0_1px_0_0_rgb(226,232,240)] dark:shadow-[0_1px_0_0_rgb(51,65,85)]", children: table.getHeaderGroups().map((headerGroup) => /* @__PURE__ */ jsxs(
                  "tr",
                  {
                    className: "bg-slate-50 dark:bg-slate-800",
                    children: [
                      enableSelection && /* @__PURE__ */ jsx("th", { className: "w-[40px] px-2 py-3 text-center bg-slate-50 dark:bg-slate-800", children: /* @__PURE__ */ jsx(
                        "input",
                        {
                          type: "checkbox",
                          checked: !!pageFullSel,
                      ...
                      headerGroup.headers.map((header) => {
                        ...
                        return /* @__PURE__ */ jsxs(
                          "th",
                          {
                            ...
                            children: [
                              isDropping && /* @__PURE__ */ jsx("div", { className: "absolute left-0 top-0 bottom-0 w-0.5 bg-primary-500 z-10" }),
                              header.isPlaceholder ? null : /* @__PURE__ */ jsxs(
                                "div",
                                {
                                  ...
                                  children: [
                                    ...
                                    (sortDir || isActive) && /* @__PURE__ */ jsxs("span", { className: "ml-1 flex shrink-0 items-center gap-0.5", children: [
                                      sortDir === "asc" && /* @__PURE__ */ jsx(ArrowUp, { className: "h-3 w-3 text-primary-600 dark:text-primary-400" }),
                                      sortDir === "desc" && /* @__PURE__ */ jsx(ArrowDown, { className: "h-3 w-3 text-primary-600 dark:text-primary-400" }),
                                      sortDir && (() => {
                                        ...
                                        return /* @__PURE__ */ jsx("span", { className: "inline-flex h-3 min-w-[12px] items-center justify-center rounded-full bg-primary-500 px-0.5 text-[9px] font-bold text-white", children: pos });
                                      })(),
                                      isActive && !sortDir && /* @__PURE__ */ jsx(Filter, { className: "h-3 w-3 text-primary-500 dark:text-primary-300" })
                                    ] }),
                                    /* @__PURE__ */ jsx(
                                      "button",
                                      {
                                        ...
                                        children: /* @__PURE__ */ jsx(ChevronDown, { className: clsx("h-3.5 w-3.5 transition-transform", activePopupId === colId && "rotate-180") })
                                      }
                                    )
                                  ]
                                }
                      ...
                      /* @__PURE__ */ jsx(
                        "th",
                        {
                          ...
                          children: /* @__PURE__ */ jsxs("div", { ref: cogRef, className: "flex items-center justify-center", children: [
                            showCogHint && !cogOpen && /* @__PURE__ */ jsxs("div", { className: "absolute right-full mr-2 top-1/2 -translate-y-1/2 z-40 flex items-center animate-bounce-gentle", children: [
                              /* @__PURE__ */ jsx("span", { className: "whitespace-nowrap rounded-md bg-amber-500 px-2.5 py-1.5 text-xs font-semibold text-white shadow-lg dark:bg-amber-400 dark:text-slate-900", children: t("table.customizeColumns") }),
                              /* @__PURE__ */ jsx("span", { className: "w-0 h-0 border-y-[5px] border-y-transparent border-l-[6px] border-l-amber-500 dark:border-l-amber-400 shrink-0" })
                            ] }),
                            /* @__PURE__ */ jsx(
                              "button",
                              {
                                  ...
                                  /* @__PURE__ */ jsxs(
                                    "button",
                                    {
                                      ...
                                      children: [
                                        ...
                                        ), children: fitColumns && /* @__PURE__ */ jsx(Check, { className: "h-3 w-3" }) }),
                                        t("table.fitToWidth")
                                      ]
                                    }
                                  ),
                                  /* @__PURE__ */ jsxs("div", { className: "border-t border-slate-100 dark:border-slate-800 px-3 py-2", children: [
                                    /* @__PURE__ */ jsx("p", { className: "text-[10px] font-semibold uppercase tracking-wider text-slate-400 mb-1.5", children: t("table.columns") }),
                                    /* @__PURE__ */ jsx("div", { className: "space-y-0.5", children: smartColumns.map((col) => {
                                      ...
                                      return /* @__PURE__ */ jsxs(
                                        "button",
                                        {
                                          ...
                                          children: [
                                            visible ? /* @__PURE__ */ jsx(Eye, { className: "h-3.5 w-3.5 text-primary-500 shrink-0" }) : /* @__PURE__ */ jsx(EyeOff, { className: "h-3.5 w-3.5 text-slate-300 dark:text-slate-600 shrink-0" }),
                ...
                /* @__PURE__ */ jsx("tbody", { className: "divide-y divide-slate-100 dark:divide-slate-800", children: loading ? skeletonRows.map((i) => /* @__PURE__ */ jsxs("tr", { children: [
                  enableSelection && /* @__PURE__ */ jsx("td", { className: "w-[40px] px-2 py-3 text-center", children: /* @__PURE__ */ jsx("div", { className: "h-4 w-4 mx-auto animate-pulse rounded bg-slate-200 dark:bg-slate-700" }) }),
                  table.getVisibleFlatColumns().map((col) => /* @__PURE__ */ jsx("td", { className: "px-4 py-3", children: /* @__PURE__ */ jsx("div", { className: "h-4 w-3/4 animate-pulse rounded bg-slate-200 dark:bg-slate-700" }) }, col.id)),
                  /* @__PURE__ */ jsx("td", { className: "sticky right-0 z-10 w-[44px] bg-white dark:bg-slate-900 border-l border-slate-100 dark:border-slate-800" })
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ jsx(
                          "td",
                          {
                            ...
                            children: onRowClick && /* @__PURE__ */ jsx("div", { className: "flex items-center justify-center", children: /* @__PURE__ */ jsx(ChevronRight, { className: "h-4 w-4 text-slate-300 dark:text-slate-600 group-hover/row:text-slate-500 dark:group-hover/row:text-slate-400 transition-colors" }) })
                          }
                        )
                      ]
                    },
                ...
                hasAggregations && /* @__PURE__ */ jsx("tfoot", { className: "sticky bottom-0 z-20", children: /* @__PURE__ */ jsxs("tr", { className: "bg-slate-50 dark:bg-slate-800", children: [
                  enableSelection && /* @__PURE__ */ jsx("td", { className: "w-[40px] px-2 py-2.5 bg-slate-50 dark:bg-slate-800 border-t border-slate-300 dark:border-slate-600" }),
                  table.getVisibleLeafColumns().map((col) => {
                    ...
                    return /* @__PURE__ */ jsx(
                      "td",
                      {
                        ...
                        children: agg ? /* @__PURE__ */ jsxs("div", { className: "flex flex-col", children: [
                          /* @__PURE__ */ jsxs(
                            "span",
                            {
                              ...
                              children: [
                                ...
                                aggregatedRowCount != null && aggregatedTotalRows != null && aggregatedTotalRows > aggregatedRowCount && /* @__PURE__ */ jsxs("span", { className: "ml-1 text-slate-500 dark:text-slate-300 normal-case tracking-normal", children: [
                                  "\xB7 ",
                                  aggregatedRowCount,
                                  "/",
                                  aggregatedTotalRows
                          ...
                          /* @__PURE__ */ jsx("span", { className: "text-sm font-medium text-slate-700 dark:text-slate-300", children: agg.value == null ? "\u2014" : agg.fn === "count" ? agg.value.toLocaleString("fr-FR") : sc?.footerFormat ? sc.footerFormat(agg.value) : sc?.type === "date" ? new Date(agg.value).toLocaleDateString("fr-FR") : agg.fn === "avg" ? agg.value.toLocaleString("fr-FR", { maximumFractionDigits: 2 }) : agg.value.toLocaleString("fr-FR") })
                        ] }) : null
                      },
                      col.id
                    );
                  }),
                  /* @__PURE__ */ jsx("td", { className: "sticky right-0 z-10 w-[44px] bg-slate-50 dark:bg-slate-800 border-l border-slate-100 dark:border-slate-800 border-t border-t-slate-300 dark:border-t-slate-600" })
                ] }) })
              ]
            }
          ),
          !loading && rows.length === 0 && /* @__PURE__ */ jsx(
            EmptyState,
            {
              title: emptyTitle,
    ...
    scrolledDown && rows.length > 0 && /* @__PURE__ */ jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxs("span", { className: "flex items-center gap-1 mt-1 text-[11px] font-medium text-slate-400 dark:text-slate-400 hover:text-primary-600 dark:hover:text-primary-400 transition-colors", children: [
...
function EmptyState({ icon: Icon, title, action }) {
  return /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center justify-center gap-3 py-12 text-center", children: [
    Icon && /* @__PURE__ */ jsx(Icon, { className: "h-10 w-10 text-slate-300 dark:text-slate-600" }),
    /* @__PURE__ */ jsx("p", { className: "text-sm text-slate-500 dark:text-slate-400", children: title }),
    action
  ] });
}
...
function SmartPagination({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center justify-between gap-3 text-sm", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 text-slate-500 dark:text-slate-400", children: [
      /* @__PURE__ */ jsx("span", { children: t("pagination.rangeOf", { from, to, total }) }),
      /* @__PURE__ */ jsx(
        "select",
        {
          value: pageSize,
          ...
          children: PAGE_SIZE_OPTIONS.map((s) => /* @__PURE__ */ jsx("option", { value: s, children: t("pagination.perPage", { count: s }) }, s))
        }
      ),
      showScrollToggle && /* @__PURE__ */ jsxs(
        "button",
        {
          onClick: () => {
          ...
          children: [
            /* @__PURE__ */ jsx(ArrowDownToLine, { className: "w-3.5 h-3.5" }),
            /* @__PURE__ */ jsx("span", { className: "hidden sm:inline", children: t("pagination.infiniteScroll") })
          ]
        }
      )
    ] }),
    totalPages > 1 && /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1", children: [
      ...
      getPageNumbers().map(
        (p, i) => p === "ellipsis" ? /* @__PURE__ */ jsx("span", { className: "px-1.5 text-slate-400", children: "..." }, `e${i}`) : /* @__PURE__ */ jsx(
          "button",
          {
...
function Accordion({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "border-t border-slate-200 dark:border-slate-700", children: [
    /* @__PURE__ */ jsxs(
      "button",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx(ChevronDown, { className: clsx("h-4 w-4 transition-transform", open && "rotate-180") })
        ]
      }
    ),
...
function ColorDot({
  ...
  return /* @__PURE__ */ jsxs("div", { ref, className: "relative flex items-center gap-2", children: [
    /* @__PURE__ */ jsx("span", { className: "text-xs text-slate-500 dark:text-slate-400 w-24 shrink-0", children: label }),
    /* @__PURE__ */ jsx(
      "button",
      {
        onClick: () => setOpen(!open),
    ...
    open && /* @__PURE__ */ jsxs("div", { className: "absolute left-24 top-full mt-1 z-50 rounded-lg border border-slate-200 bg-white p-2.5 shadow-lg dark:border-slate-700 dark:bg-slate-900 w-[200px]", children: [
      /* @__PURE__ */ jsx("div", { className: "grid grid-cols-6 gap-1.5", children: PRESET_COLORS.map((c) => /* @__PURE__ */ jsx(
        "button",
        {
          onClick: () => {
            onChange(c);
      ...
      /* @__PURE__ */ jsxs("div", { className: "mt-2 flex items-center gap-1.5 border-t border-slate-100 dark:border-slate-800 pt-2", children: [
        /* @__PURE__ */ jsx(
          "input",
          {
            type: "color",
        ...
        /* @__PURE__ */ jsx("span", { className: "text-[10px] text-slate-400", children: t("custom") })
      ] })
    ] })
  ] });
}
function ButtonGroup({
  ...
  return /* @__PURE__ */ jsx("div", { className: "inline-flex rounded-lg border border-slate-200 dark:border-slate-700 overflow-hidden", children: options.map((opt) => /* @__PURE__ */ jsx(
    "button",
    {
...
function ColumnStyler({ style, setStyle }) {
  const { t } = useTranslation("common", { keyPrefix: "smartTable" });
  return /* @__PURE__ */ jsx(Accordion, { title: t("appearance.title"), icon: /* @__PURE__ */ jsx(Paintbrush, { className: "h-4 w-4" }), defaultOpen: false, children: /* @__PURE__ */ jsxs("div", { className: "space-y-2.5", children: [
    /* @__PURE__ */ jsx(
      ColorDot,
      {
    ...
    (style.borderLeft || style.borderRight) && /* @__PURE__ */ jsxs("div", { children: [
      /* @__PURE__ */ jsx("p", { className: "mb-1.5 text-xs text-slate-500 dark:text-slate-400", children: t("appearance.borderWidth") }),
      /* @__PURE__ */ jsx(
        ButtonGroup,
        {
          options: [
    ...
    /* @__PURE__ */ jsxs("div", { children: [
      /* @__PURE__ */ jsx("p", { className: "mb-1.5 text-xs text-slate-500 dark:text-slate-400", children: t("appearance.weight") }),
      /* @__PURE__ */ jsx(
        ButtonGroup,
        {
          options: [
    ...
    /* @__PURE__ */ jsxs("div", { children: [
      /* @__PURE__ */ jsx("p", { className: "mb-1.5 text-xs text-slate-500 dark:text-slate-400", children: t("appearance.style") }),
      /* @__PURE__ */ jsx(
        ButtonGroup,
        {
          options: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("p", { className: "mb-1.5 text-xs text-slate-500 dark:text-slate-400", children: t("appearance.size") }),
        /* @__PURE__ */ jsx(
          ButtonGroup,
          {
            options: [
      ...
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("p", { className: "mb-1.5 text-xs text-slate-500 dark:text-slate-400", children: t("appearance.alignment") }),
        /* @__PURE__ */ jsx("div", { className: "inline-flex rounded-lg border border-slate-200 dark:border-slate-700 overflow-hidden", children: [
          { value: "left", icon: /* @__PURE__ */ jsx(AlignLeft, { className: "h-3.5 w-3.5" }) },
          { value: "center", icon: /* @__PURE__ */ jsx(AlignCenter, { className: "h-3.5 w-3.5" }) },
          { value: "right", icon: /* @__PURE__ */ jsx(AlignRight, { className: "h-3.5 w-3.5" }) }
    ...
    /* @__PURE__ */ jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsx("span", { className: "text-slate-600 dark:text-slate-400", children: t("appearance.sampleText") })
      }
    )
  ] }) });
}
...
function ColumnPopup({
  ...
  const [sort, setSort] = useState(currentSettings.sort ?? null);
  const [filterTextOp, setFilterTextOp] = useState(currentSettings.filterTextOp ?? "contains");
  ...
  const [aggFn, setAggFn] = useState(currentSettings.aggFn ?? column.footerAgg ?? null);
  const [filterNumberOp, setFilterNumberOp] = useState(currentSettings.filterNumberOp ?? "between");
  const [filterNumberFrom, setFilterNumberFrom] = useState(currentSettings.filterNumberFrom != null ? String(currentSettings.filterNumberFrom) : "");
  const [filterNumberTo, setFilterNumberTo] = useState(currentSettings.filterNumberTo != null ? String(currentSettings.filterNumberTo) : "");
  ...
  const [entityActiveInput, setEntityActiveInput] = useState("main");
  const entityMainRef = useRef(null);
  ...
  const renderOptionLabel = (opt) => {
    ...
    return /* @__PURE__ */ jsx("span", { className: "text-sm text-slate-700 dark:text-slate-300", children: opt.label });
  };
  useEffect(() => {
    const handler = (e) => {
      if (e.key === "Escape") onClose();
  ...
  const lastSentRef = useRef(JSON.stringify(currentSettings));
  useEffect(() => {
  ...
  return /* @__PURE__ */ jsxs("div", { ref: panelRef, style: popupStyle, className: "flex items-start gap-2", children: [
    /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between px-4 py-2.5 border-b border-slate-200 dark:border-slate-700", children: [
            /* @__PURE__ */ jsxs("div", { className: "min-w-0 flex-1", children: [
              /* @__PURE__ */ jsx("p", { className: "text-[10px] font-semibold uppercase tracking-wider text-slate-400", children: t("column.label") }),
              /* @__PURE__ */ jsx("p", { className: "text-sm font-medium text-slate-800 dark:text-slate-200 truncate", children: column.header })
            ] }),
            /* @__PURE__ */ jsx(
              "button",
              {
          ...
          (column.sortable ?? true) && /* @__PURE__ */ jsxs("div", { className: "px-4 py-3", children: [
            /* @__PURE__ */ jsx("p", { className: "mb-2 text-xs font-semibold uppercase tracking-wider text-slate-400", children: t("sort.title") }),
            /* @__PURE__ */ jsxs("div", { className: "flex gap-2", children: [
              /* @__PURE__ */ jsxs(
                "button",
                {
                  ...
                  children: [
                    isNumberColumn ? /* @__PURE__ */ jsx(ArrowUp, { className: "h-3.5 w-3.5" }) : /* @__PURE__ */ jsx(ArrowUpAZ, { className: "h-3.5 w-3.5" }),
              ...
              /* @__PURE__ */ jsxs(
                "button",
                {
                  ...
                  children: [
                    isNumberColumn ? /* @__PURE__ */ jsx(ArrowDown, { className: "h-3.5 w-3.5" }) : /* @__PURE__ */ jsx(ArrowDownAZ, { className: "h-3.5 w-3.5" }),
          ...
          (column.filterable ?? true) && /* @__PURE__ */ jsxs(Accordion2, { title: t("filter.title"), icon: /* @__PURE__ */ jsx(Filter, { className: "h-4 w-4" }), defaultOpen: true, children: [
            isDateColumn ? /* @__PURE__ */ jsxs("div", { className: "space-y-2 mb-2", children: [
              /* @__PURE__ */ jsx("div", { className: "flex flex-wrap gap-1", children: datePresets.map((p) => /* @__PURE__ */ jsx(
                "button",
                {
              ...
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsx("label", { className: "text-xs text-slate-500 dark:text-slate-400 w-8 shrink-0", children: t("filter.from") }),
              ...
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsx("label", { className: "text-xs text-slate-500 dark:text-slate-400 w-8 shrink-0", children: t("filter.to") }),
                /* @__PURE__ */ jsx("div", { className: "flex-1", children: /* @__PURE__ */ jsx(
                  "input",
                  {
                    type: "date",
              ...
              (filterDateFrom || filterDateTo) && /* @__PURE__ */ jsx(
                "button",
                {
                  onClick: () => {
                    setFilterDateFrom("");
            ...
            ] }) : isTimeColumn ? /* @__PURE__ */ jsxs("div", { className: "space-y-2 mb-2", children: [
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsx("label", { className: "text-xs text-slate-500 dark:text-slate-400 w-8 shrink-0", children: t("filter.from") }),
                /* @__PURE__ */ jsx(
                  "input",
            ...
            ] }) : isNumberColumn && !hasExplicitOptions ? /* @__PURE__ */ jsxs("div", { className: "space-y-2 mb-2", children: [
              /* @__PURE__ */ jsx(
                "select",
                {
                  ...
                  children: NUM_OP_OPTIONS.map((o) => /* @__PURE__ */ jsx("option", { value: o.value, children: o.label }, o.value))
                }
              ),
              needsNumberValue && (filterNumberOp === "between" ? /* @__PURE__ */ jsxs(Fragment, { children: [
                /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                  /* @__PURE__ */ jsx("label", { className: "text-xs text-slate-500 dark:text-slate-400 w-8 shrink-0", children: t("filter.min") }),
                  /* @__PURE__ */ jsx(
                    "input",
                    {
                      type: "number",
                ...
                /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                  /* @__PURE__ */ jsx("label", { className: "text-xs text-slate-500 dark:text-slate-400 w-8 shrink-0", children: t("filter.max") }),
                  /* @__PURE__ */ jsx(
                    "input",
                    {
                      type: "number",
              ...
              /* @__PURE__ */ jsx(
                "select",
                {
                  ...
                  className: "w-full rounded-lg border border-slate-200 bg-white px-2 py-1.5 text-sm text-slate-700 focus:border-primary-400 focus:outline-none focus:ring-1 focus:ring-primary-400 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-300",
                  children: TEXT_OP_OPTIONS.map((o) => /* @__PURE__ */ jsx("option", { value: o.value, children: o.label }, o.value))
                }
              ),
              needsTextInput && /* @__PURE__ */ jsxs("div", { className: "relative", children: [
                /* @__PURE__ */ jsx(Search, { className: "absolute left-2.5 top-1/2 h-3.5 w-3.5 -translate-y-1/2 text-slate-400" }),
                /* @__PURE__ */ jsx(
                  "input",
                  {
                    type: "text",
            ...
            showCheckboxes && /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsxs("div", { className: "mb-1.5 flex items-center justify-between", children: [
                /* @__PURE__ */ jsxs("div", { className: "flex gap-2", children: [
                  /* @__PURE__ */ jsx("button", { onClick: selectAll, className: "text-xs font-medium text-primary-600 hover:text-primary-700 dark:text-primary-400", children: t("checkbox.all") }),
                  /* @__PURE__ */ jsx("button", { onClick: selectNone, className: "text-xs font-medium text-slate-400 hover:text-slate-600 dark:text-slate-400 dark:hover:text-slate-300", children: t("checkbox.none") })
                ] }),
                /* @__PURE__ */ jsx("span", { className: "text-[10px] text-slate-400", children: t("checkbox.valuesCount", { count: filterOptions.length }) })
              ] }),
              needsSearch && /* @__PURE__ */ jsxs("div", { className: "relative mb-1.5", children: [
                /* @__PURE__ */ jsx(Search, { className: "absolute left-2 top-1/2 h-3 w-3 -translate-y-1/2 text-slate-400" }),
                /* @__PURE__ */ jsx(
                  "input",
                  {
                    type: "text",
              ...
              /* @__PURE__ */ jsxs("div", { className: "max-h-44 overflow-y-auto space-y-0.5", children: [
                  ...
                  return /* @__PURE__ */ jsxs(
                    "label",
                    {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ jsx("span", { className: "flex-1 min-w-0", children: renderOptionLabel(opt) })
                      ]
                    },
                    opt.value
                  );
                }),
                filteredOptions.length === 0 && /* @__PURE__ */ jsx("p", { className: "py-2 text-center text-xs text-slate-400", children: t("noMatchingValues") })
              ] })
            ] })
          ] }),
          aggOptions.length > 0 && /* @__PURE__ */ jsxs("div", { className: "border-t border-slate-200 dark:border-slate-700 px-4 py-3", children: [
            /* @__PURE__ */ jsx("p", { className: "mb-2 text-xs font-semibold uppercase tracking-wider text-slate-400", children: t("footer.title") }),
            /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap gap-1.5", children: [
              ...
              aggOptions.map((fn) => /* @__PURE__ */ jsx(
                "button",
                {
          ...
          /* @__PURE__ */ jsx(ColumnStyler, { style, setStyle }),
          hasEntityDesigner && /* @__PURE__ */ jsx("div", { className: "border-t border-slate-200 dark:border-slate-700", children: /* @__PURE__ */ jsxs(
            "button",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsx(ChevronRight, { className: clsx("h-4 w-4 transition-transform", designerOpen && "text-primary-500") })
              ]
            }
          ) }),
          /* @__PURE__ */ jsxs("div", { className: "relative flex items-center justify-between border-t border-slate-200 px-4 py-2.5 dark:border-slate-700", children: [
            /* @__PURE__ */ jsx(
              "button",
              {
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
              onAddHiddenColumn && hiddenColumnsList && hiddenColumnsList.length > 0 && /* @__PURE__ */ jsx(
                "button",
                {
            ...
            addColumnOpen && hiddenColumnsList && onAddHiddenColumn && /* @__PURE__ */ jsxs(Fragment, { children: [
              /* @__PURE__ */ jsx("div", { className: "fixed inset-0 z-[9998]", onClick: () => setAddColumnOpen(false) }),
              /* @__PURE__ */ jsxs("div", { className: "absolute bottom-full right-10 mb-1 z-[9999] w-60 rounded-lg border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 shadow-xl overflow-hidden", children: [
                /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 border-b border-slate-100 dark:border-slate-800 px-3 py-2", children: [
                  /* @__PURE__ */ jsx(Search, { className: "h-3.5 w-3.5 text-slate-400 dark:text-slate-500" }),
                  /* @__PURE__ */ jsx(
                    "input",
                    {
                      autoFocus: true,
                ...
                /* @__PURE__ */ jsxs("div", { className: "max-h-[240px] overflow-y-auto py-1", children: [
                  hiddenColumnsList.filter((c) => c.header.toLowerCase().includes(addColumnSearch.toLowerCase())).map((c) => /* @__PURE__ */ jsxs(
                    "button",
                    {
                      onClick: () => {
                      ...
                      children: [
                        /* @__PURE__ */ jsx(Plus, { className: "h-3 w-3 text-slate-400 dark:text-slate-500 shrink-0" }),
                        /* @__PURE__ */ jsx("span", { className: "truncate", children: c.header })
                      ]
                    },
                    c.id
                  )),
                  hiddenColumnsList.filter((c) => c.header.toLowerCase().includes(addColumnSearch.toLowerCase())).length === 0 && /* @__PURE__ */ jsx("div", { className: "px-3 py-2 text-xs text-slate-400 dark:text-slate-500", children: t("noHiddenColumns") })
                ] })
              ] })
            ] })
          ] })
    ...
    designerOpen && hasEntityDesigner && /* @__PURE__ */ jsxs("div", { className: "w-[360px] max-h-[70vh] overflow-y-auto rounded-xl border border-slate-200 bg-white shadow-xl animate-fade-in dark:border-slate-700 dark:bg-slate-900", children: [
      /* @__PURE__ */ jsxs("div", { className: "sticky top-0 z-10 flex items-center justify-between border-b border-slate-200 bg-white px-4 py-3 dark:border-slate-700 dark:bg-slate-900", children: [
        /* @__PURE__ */ jsx("h3", { className: "text-sm font-semibold text-slate-800 dark:text-slate-200", children: t("designer.title") }),
        /* @__PURE__ */ jsx(
          "button",
          {
      ...
      sampleEntity != null && (() => {
        ...
        return /* @__PURE__ */ jsxs("div", { className: "mx-4 mt-3 rounded-lg border border-slate-200 bg-gradient-to-br from-slate-50 to-white p-3 dark:border-slate-700 dark:from-slate-800/50 dark:to-slate-900", children: [
          /* @__PURE__ */ jsx("p", { className: "text-[10px] font-medium uppercase tracking-wider text-slate-400 mb-2", children: t("designer.preview") }),
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
            hasImg && (imgUrl ? /* @__PURE__ */ jsx("img", { src: imgUrl, alt: "", className: "h-11 w-11 rounded-lg object-cover shrink-0 bg-slate-200 dark:bg-slate-700 shadow-sm" }) : /* @__PURE__ */ jsx("div", { className: "h-11 w-11 rounded-lg shrink-0 bg-slate-200 dark:bg-slate-700 flex items-center justify-center shadow-sm", children: /* @__PURE__ */ jsx(Home, { className: "h-5 w-5 text-slate-400 dark:text-slate-500" }) })),
            /* @__PURE__ */ jsxs("div", { className: "min-w-0", children: [
              /* @__PURE__ */ jsx("div", { className: "text-sm font-medium text-slate-800 dark:text-slate-200 truncate", children: resolveTemplate(entityMainLine, sampleEntity, entityFormatMap) || "\u2014" }),
              entitySubLine && /* @__PURE__ */ jsx("div", { className: "text-xs text-slate-500 dark:text-slate-400 truncate mt-0.5", children: resolveTemplate(entitySubLine, sampleEntity, entityFormatMap) })
            ] })
          ] })
        ] });
      })(),
      /* @__PURE__ */ jsxs("div", { className: "px-4 pt-4 pb-3 space-y-3", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("label", { className: "flex items-center gap-1.5 text-xs font-medium text-slate-600 dark:text-slate-400 mb-1.5", children: t("designer.mainLine") }),
          /* @__PURE__ */ jsx(
            "input",
            {
              ref: entityMainRef,
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsxs("label", { className: "flex items-center gap-1.5 text-xs font-medium text-slate-600 dark:text-slate-400 mb-1.5", children: [
            t("designer.subLine"),
            /* @__PURE__ */ jsx("span", { className: "font-normal text-slate-400 text-[10px]", children: t("designer.optional") })
          ] }),
          /* @__PURE__ */ jsx(
            "input",
            {
      ...
      /* @__PURE__ */ jsxs("div", { className: "border-t border-slate-100 dark:border-slate-800 px-4 py-3", children: [
        /* @__PURE__ */ jsx("p", { className: "text-[10px] font-medium uppercase tracking-wider text-slate-400 mb-2.5", children: t("designer.clickToInsert") }),
        /* @__PURE__ */ jsx("div", { className: "space-y-2.5", children: entityGrouped.map(([group, vars]) => /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("p", { className: "text-[10px] font-semibold text-slate-500 dark:text-slate-400 mb-1", children: group }),
          /* @__PURE__ */ jsx("div", { className: "flex flex-wrap gap-1", children: vars.map((v) => /* @__PURE__ */ jsx(
            "button",
            {
      ...
      /* @__PURE__ */ jsxs("div", { className: "border-t border-slate-100 dark:border-slate-800 px-4 py-3", children: [
        /* @__PURE__ */ jsx("label", { className: "block text-xs font-medium text-slate-600 dark:text-slate-400 mb-1.5", children: t("designer.sortBy") }),
        /* @__PURE__ */ jsxs(
          "select",
          {
            ...
            children: [
              /* @__PURE__ */ jsx("option", { value: "", children: t("designer.default") }),
              entityVars.filter((v) => !v.key.includes(".") || v.format).map((v) => /* @__PURE__ */ jsx("option", { value: v.key, children: v.label }, v.key))
            ]
          }
        )
      ] }),
      entityDefaults && /* @__PURE__ */ jsx("div", { className: "border-t border-slate-100 dark:border-slate-800 px-4 py-3", children: /* @__PURE__ */ jsxs(
        "button",
        {
          onClick: () => {
...
function FilterPills({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center gap-2", children: [
    /* @__PURE__ */ jsx("span", { className: "text-xs font-medium text-slate-500 dark:text-slate-400", children: t("activeFilters") }),
...
function ExportDropdown({ onCSV, onExcel }) {
  ...
  return /* @__PURE__ */ jsxs("div", { ref, className: "relative", children: [
    ...
    open && /* @__PURE__ */ jsxs("div", { className: "absolute right-0 top-full z-50 mt-1 w-40 overflow-hidden rounded-lg border border-slate-200 bg-white py-1 shadow-lg dark:border-slate-700 dark:bg-slate-900", children: [
      /* @__PURE__ */ jsxs(
        "button",
        {
          onClick: () => {
          ...
          children: [
            /* @__PURE__ */ jsx("span", { className: "inline-flex h-5 w-5 items-center justify-center rounded bg-emerald-100 text-[9px] font-bold text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-400", children: "CSV" }),
            t("export.csv")
          ]
        }
      ),
      /* @__PURE__ */ jsxs(
        "button",
        {
          ...
          className: "flex w-full items-center gap-2 px-3 py-2 text-left text-sm text-slate-700 hover:bg-slate-50 dark:bg-slate-900 dark:text-slate-300 dark:hover:bg-slate-800",
          children: [
            /* @__PURE__ */ jsx("span", { className: "inline-flex h-5 w-5 items-center justify-center rounded bg-green-100 text-[9px] font-bold text-green-700 dark:bg-green-900/30 dark:text-green-400", children: "XLS" }),
            t("export.excel")
          ]
        }
      )
...
function SmartDataTable({
  ...
  const allSmartColumns = useMemo(() => {
    const idCol = {
      id: "_id",
      header: "ID",
      // Technical column header — keep untranslated; consumers can override via column override
      accessorFn: (row) => resolvedGetRowId(row),
      cell: ({ value }) => /* @__PURE__ */ jsx("span", { className: "inline-block rounded bg-slate-100 dark:bg-slate-700 px-1.5 py-0.5 font-mono text-xs text-slate-500 dark:text-slate-400 select-all", children: String(value).slice(0, 8) }),
      sortable: false,
      filterable: false,
      size: 95,
      fixed: true
  ...
  const lastServerSearchRef = useRef(null);
  useEffect(() => {
    ...
    () => allSmartColumns.map((sc) => {
      ...
      if (sc.entityType && sc.entityAccessor && ecfg) {
        ...
        def.cell = (info) => {
          ...
          if (!entity) return /* @__PURE__ */ jsx("span", { className: "text-slate-400", children: "\u2014" });
          ...
          const PlaceholderIcon = sc.entityType === "bien" ? Home : sc.entityType === "contact" || sc.entityType === "acquereur" ? User : ImageIcon;
          return /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2.5", children: [
            showPhoto && (imageUrl ? /* @__PURE__ */ jsx(
              "img",
              {
                src: imageUrl,
                alt: "",
            ...
            ) : /* @__PURE__ */ jsx("div", { className: "h-10 w-10 rounded-md shrink-0 bg-slate-100 dark:bg-slate-800 flex items-center justify-center", children: /* @__PURE__ */ jsx(PlaceholderIcon, { className: "h-5 w-5 text-slate-300 dark:text-slate-600" }) })),
            /* @__PURE__ */ jsxs("div", { className: "min-w-0", children: [
              /* @__PURE__ */ jsx("div", { className: "font-medium truncate", children: mainText || "\u2014" }),
              subText && /* @__PURE__ */ jsx("div", { className: "text-xs text-slate-500 dark:text-slate-400 truncate", children: subText })
            ] })
          ] });
        };
      } else {
  ...
  const [scrollMode, setScrollMode2] = useState(getScrollMode);
  ...
  const [filterPopupRect, setFilterPopupRect] = useState(null);
  ...
  return /* @__PURE__ */ jsxs("div", { className: "space-y-3", children: [
    /* @__PURE__ */ jsx("div", { className: "flex items-center gap-2", children: enableSelection && selectionActive ? /* @__PURE__ */ jsxs(Fragment, { children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 flex-1 min-w-0", children: [
        /* @__PURE__ */ jsx(CheckSquare, { className: "h-4 w-4 text-primary-600 dark:text-primary-400 shrink-0" }),
        /* @__PURE__ */ jsx("span", { className: "text-sm font-medium text-primary-700 dark:text-primary-300 whitespace-nowrap", children: t("selection.selected", { count: selection.state.count }) }),
        !allSelectedAcrossPages && selection.state.count === pageRows.length && totalRows > pageRows.length && /* @__PURE__ */ jsxs(Fragment, { children: [
        ...
        allSelectedAcrossPages && totalRows > pageRows.length && /* @__PURE__ */ jsx("span", { className: "text-xs text-primary-500 dark:text-primary-400 whitespace-nowrap", children: t("selection.allPages") }),
        /* @__PURE__ */ jsx("span", { className: "text-slate-300 dark:text-slate-600", children: "|" }),
        /* @__PURE__ */ jsxs(
          "button",
          {
      ...
      /* @__PURE__ */ jsxs("div", { className: "relative flex-1 group/search", children: [
        searchPending ? /* @__PURE__ */ jsx(Loader2, { className: "absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-primary-500 animate-spin" }) : /* @__PURE__ */ jsx(Search, { className: "absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-slate-400" }),
        /* @__PURE__ */ jsx(
          "input",
          {
            type: "text",
        ...
        activeFilterCount > 0 && /* @__PURE__ */ jsx("div", { className: "absolute right-2 top-1/2 -translate-y-1/2", children: /* @__PURE__ */ jsx(
          "button",
          {
            ref: (el) => {
    ...
    Object.values(allSettings).some((s) => s.sort || s.filterText || s.filterValues?.length || s.filterDateFrom || s.filterDateTo || s.filterNumberFrom != null || s.filterNumberTo != null) && /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center gap-2", children: [
      /* @__PURE__ */ jsx("span", { className: "text-xs font-medium text-slate-500 dark:text-slate-400", children: t("activeFilters") }),
      Object.entries(allSettings).map(([colId, s]) => {
        const col = allSmartColumns.find((c) => c.id === colId);
        if (!col) return null;
        ...
        if (parts.length === 0) return null;
        return /* @__PURE__ */ jsxs("span", { className: "inline-flex items-center gap-1 rounded-full bg-primary-100 px-2.5 py-1 text-xs font-medium text-primary-700 dark:bg-primary-900/40 dark:text-primary-300", children: [
          col.header,
          ": ",
          parts.join(", "),
          /* @__PURE__ */ jsx("button", { onClick: () => {
            ...
            delete next[colId];
            updateSettings(next);
          }, className: "hover:text-primary-900 dark:hover:text-primary-100", children: /* @__PURE__ */ jsx(X, { className: "h-3 w-3" }) })
        ] }, colId);
      }),
      /* @__PURE__ */ jsx(
        "button",
    ...
    viewMode === "table" && /* @__PURE__ */ jsxs(Fragment, { children: [
      /* @__PURE__ */ jsx(
        TableView,
        {
          table,
      ...
      enablePagination && totalRows > 0 && scrollMode === "pagination" && /* @__PURE__ */ jsx(
        SmartPagination,
        {
      ...
      scrollMode === "infinite" && totalRows > 0 && /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between text-xs text-slate-400 dark:text-slate-400 pt-2", children: [
    ...
    activePopup && popupSmartColumn && /* @__PURE__ */ jsx(
      ColumnPopup,
      {
    ...
    activePopup === "__filters" && filterPopupRect && /* @__PURE__ */ jsxs(Fragment, { children: [
      /* @__PURE__ */ jsx("div", { className: "fixed inset-0 z-[9998]", onClick: () => setActivePopup(null) }),
      /* @__PURE__ */ jsx(
        "div",
        {
